...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3f(glGetUniformLocation(shaderID, "lightPosition"), mainLight.position.x, mainLight.position.y, mainLight.position.z);
        glUniform3f(glGetUniformLocation(shaderID, "lightColor"), mainLight.color.x, mainLight.color.y, mainLight.color.z);
